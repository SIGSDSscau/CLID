...
parser.add_argument('--use_hard_vote', '-hv', action='store_true', default=True) 
...
parser.add_argument('--embedding_dim', '-ed', type=int, default=64) 
parser.add_argument('--encoder_hidden_dim', '-ehd', type=int, default=256)
parser.add_argument('--decoder', type=str, default='agif')
...
parser.add_argument('--n_head', '-nh', type=int, default=8) 
...
parser.add_argument('--embed_type',
                    ...
                    type=str,
                    default='None',
                    help='w2v|bert|wpb|elmo')
parser.add_argument('--bert_path',
                    '-bt',
                    type=str,
                    default='/devdata/water/pretrain/bert-base-uncased',
                    )
